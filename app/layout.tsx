...
export const metadata: Metadata = {
  ...
  keywords: ['plots for sale Agartala', 'residential land Tripura', '17 Kani township', 'TUDA approved plots', 'buy land in Tripura', 'buy land in northeast', 'buy land India'],
  openGraph: {
